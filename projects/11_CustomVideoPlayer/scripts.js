...
progress.addEventListener('mousemove', (e) => mousedown && scrub(e)); // checks if mousedown is true then it moves over to run the scrub().  If mousedown is false then it won't run scrub()
